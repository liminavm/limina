...
// What this build is: version, date, and the revision of every dependency it carries
// (the About menu).
mod about;
mod balloon_policy;
mod center;
...
fn main() -> Result<()> {
    ...
    // (see `limina_paniclog`). `supervisor::install_panic_kill_hook` chains on top of this later.
