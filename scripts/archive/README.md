...
| `build-mesa-zink.sh` | `scripts/build-mesa-rpm.sh` | Prefix-style guest zink+venus build, superseded by the RPM delivery — and **zink-as-guest-GL was dropped as a supported configuration 2026-08-04** (GL rides virgl/vrend, venus stays for Vulkan; `docs/graphics.md` §3.2). |
