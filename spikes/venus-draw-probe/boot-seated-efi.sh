...
#
# EFI VARIANT of boot-seated-kk.sh: no --kernel; the guest GRUB boots the installed 16k
# kernel RPM + sysexts (validates the PRODUCTIZED enhanced image). --window auto-selects GOP.
