...
# One leg of the 2026-09-17 virglrs robustness pass: build limina's HEAD against a given virglrs +
...
# run scored). A copy of perf/virglrs-legs-2026-09-16/point.sh with this pass's directory; rows go
...
#
# Usage: perf/virglrs-robustness-2026-09-17/point.sh <label> <virglrs-rev> <libkrun-rev>
...
DIR=perf/virglrs-robustness-2026-09-17
EV="$DIR/evidence/$LABEL"; LEDGER="$DIR/ledger.csv"
mkdir -p "$EV" perf/virglrs-robustness-2026-09-17/work.noindex/harness
...
ENH=perf/virglrs-robustness-2026-09-17/work.noindex/trend-enh.raw
STOCK=perf/virglrs-robustness-2026-09-17/work.noindex/trend-stock.raw
drop_clones() { rm -f perf/virglrs-robustness-2026-09-17/work.noindex/trend-enh.raw perf/virglrs-robustness-2026-09-17/work.noindex/trend-stock.raw; }
...
log "enhanced boot"
boot "$ENH" Fedora-Workstation-44.enhanced.raw "$ROOT/perf/virglrs-robustness-2026-09-17/work.noindex/aq-capture.png" ||
...
[ "${ARMS:-all}" = contended ] || for r in r1 r2; do
  LIMINA_SSH_PORT="$PORT" LIMINA_CAPTURE="$ROOT/perf/virglrs-robustness-2026-09-17/work.noindex/aq-capture.png" AQ_OUT="$EV/aquarium-$r" \
...
for f in client-basemark.sh marionette.py tap-keys.py; do   # one frozen harness for every point
  git -C third_party/virglrs show "d0416c9:harness/vm/$f" > "perf/virglrs-robustness-2026-09-17/work.noindex/harness/$f"
done
scp -P "$PORT" "${SSHO[@]}" -q perf/virglrs-robustness-2026-09-17/work.noindex/harness/client-basemark.sh perf/virglrs-robustness-2026-09-17/work.noindex/harness/marionette.py \
  perf/virglrs-robustness-2026-09-17/work.noindex/harness/tap-keys.py claude@127.0.0.1:/tmp/
